module.exports = function (app) {
    ...
    app.get('/bbb/movie/popular/:page', findPopularMovies);
    app.get('/bbb/movie/similar/:mid', findSimilarMovies);
    app.get('/bbb/movie/top', findTopMovies);
    app.get('/bbb/movie/upcoming', findUpcomingMovies);
    app.get('/bbb/movie/genres', getGenreList);
    app.get('/bbb/movie/credits/:mid', getMovieCredits);
    app.get('/bbb/movie/details/:mid', getMovieDetailsById);
    app.get('/bbb/movie/search/:title/page/:page', getMoviesByTitle);
    app.get('/bbb/movie/video/:mid', getVideoKey);
